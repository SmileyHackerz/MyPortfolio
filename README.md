...
En ligne : https://mohamed-faye-portfolio.vercel.app/
...
| | |
| --- | --- |
| Profil, contact, réseaux | `src/data/profile.ts` |
...
| Diplômes et certifications | `src/data/credentials.ts` |
...
En développement, `?section=skills` monte une seule section (`home`, `projects`, `skills`, `journey`, `credentials`, `about`, `contact`).
