...
- **Schéma de projet** (`ProjectDiagram`) : quand un projet n'a pas d'écran à photographier, la couverture cède la place aux étapes réelles de sa boucle, numérotées et reliées par une flèche. Le panneau s'annonce « Schéma · … » : il ne doit jamais pouvoir passer pour une capture.
